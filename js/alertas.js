// Alerta Bienvenida - Local Storage:
function mensajeBienvenida(visitaAnterior) {
  return Swal.fire({
    icon: false,
    title: "¡Nos alegra verte de vuelta!",
    html:
      "La última vez consultaste por " +
      visitaAnterior.pais +
      " " +
      visitaAnterior.bandera +
      ", país que <b>" +
      visitaAnterior.permiso +
      " requiere</b> de permiso previo o visa para ingresar a Chile.",
    confirmButtonText: '<i class="fa fa-thumbs-up"></i> ¡OK!',
    confirmButtonColor: "#1155cc",
  });
}
// Alerta Nivel Sanitario en Chile - Actualmente Nivel1:
const alertaNivel1 = () => {
  Swal.fire({
    title:
      "<strong>REQUISITOS SANITARIOS DE INGRESO A CHILE EN <u>ALERTA NIVEL 1</u>:</strong>",
    icon: "info",
    width: "95%",
    html:
...
function actividadesRemuneradas() {
  Swal.fire({
    title:
      "<strong>Permiso para extranjeros que desarrollan actividades lícitas remuneradas</strong>",
    icon: "info",
    width: "95%",
    html:
...
function permisoEstudios() {
  Swal.fire({
    title:
      "<strong>Permiso para extranjeros que busquen establecerse en el país con el objetivo de estudiar en establecimientos educacionales reconocidos por el Estado</strong>",
    icon: "info",
    width: "95%",
    html:
...
function permisoAcuerdosInternacionales() {
  Swal.fire({
    title:
      "<strong>Permiso para personas acogidas a acuerdos internacionales</strong>",
    icon: "info",
    width: "95%",
    html:
...
function permisoReligiosos() {
  Swal.fire({
    title:
      "<strong>Permiso para religiosos de cultos reconocidos oficialmente</strong>",
    icon: "info",
    width: "95%",
    html:
...
function tratamientosMedicos() {
  Swal.fire({
    title:
      "<strong>Permiso para extranjeros que se encuentren bajo tratamientos médicos</strong>",
    icon: "info",
    width: "95%",
    html:
...
function permisoExResidentes() {
  Swal.fire({
    title:
      "<strong>Permiso para ex titulares de residencia definitiva</strong>",
    icon: "info",
    width: "95%",
    html:
...
function permisoInversionistas() {
  Swal.fire({
    title:
      "<strong>Permiso para inversionistas y personal relacionado</strong>",
    icon: "info",
    width: "95%",
    html:
...
function consultaDolar() {
  ...
  let month = diaConsulta.getMonth() + 1;
  ...
  if (diaDelCeroalSeis == 6) {
    let viernes = day - 1;
    fetch(
      `https://api.cmfchile.cl/api-sbifv3/recursos_api/dolar/${year}/${month}/dias/${viernes}?apikey=b0c68a9c609c9a24f820d844973a39058ea443a7&formato=json`
    )
      ...
      .then((data) => {
        ...
        Swal.fire({
          title:
            "1 dólar de los Estados Unidos de América equivale a " +
            precio +
            " pesos chilenos",
          confirmButtonColor: "#1155cc",
        });
  ...
  // Si es día de semana:
    ...
    fetch(
      "https://api.sbif.cl/api-sbifv3/recursos_api/dolar?apikey=b0c68a9c609c9a24f820d844973a39058ea443a7&formato=json"
    )
      .then((response) => response.json())
      .then((data) => {
        const precio = data["Dolares"][0]["Valor"];
